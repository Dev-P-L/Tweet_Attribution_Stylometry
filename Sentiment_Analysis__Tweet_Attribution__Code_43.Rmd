...
```{r Downloading data, class.output = "bg-warning"}
...
# Prints data frame description with bg-warning layout
...
```{r Squeezing dataset, class.output = "bg-warning"}
...
# Prints table with "bg-warning" layout. 
...
# Printing table with "bg-warning" layout. 
...
graphic_function <- function(data, title) {
...
for (i in 1:2) {
  ...
  p$x$data[[i]]$text <- 
    str_replace(p$x$data[[i]]$text, "n:", "# Instances:")
...
graphic_function(output_partial, graph_title)
...
# Constructs a table with a freely customizable header. 
