...
**Tweet attribution** is the topic of this project. Tweets come from the account of Candidate Donald Trump during the 2016 presidential election campaign. Two devices have been used to issue tweets: and Android device and an iPhone. The challenge has been to predict the device on the validation set. 
