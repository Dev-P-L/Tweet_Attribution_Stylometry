...
Let's replace dots with empty space characters if dot sare trailing dots 
...
# We also discard apostrophes in other positions, e.g. in 
# genitives without s or in abreviated dates.
train_tweets$text <- str_replace_all(train_tweets$text, 
                         "'", " ") 
