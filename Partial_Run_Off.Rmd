...
<style type = "text/css">   
// Color etc. of title, headers, links, URLs.
h1.title {
        color: black;
...
For your convenience, the dataset has already been downloaded onto the GitHub repository wherefrom it will be automatically retrieved by the code from SA_Amazon_Code.Rmd. If you so wish, you can also easily retrieve the dataset from 
[UCI Archive](https://archive.ics.uci.edu/ml/datasets/Sentiment+Labelled+Sentences) and adapt the SA_Amazon_Code.Rmd code accordingly.
