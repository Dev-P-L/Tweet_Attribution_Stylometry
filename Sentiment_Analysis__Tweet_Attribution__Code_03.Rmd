...
# Before coping with colors, let us clear up 
# the workspace in order to free space. 
...
# Now, let's manage messages and warnings.
...
# Prints table with "bg-secondary" layout. 

knitr::kable(tab, table.attr = "class=\'bg-secondary\'") %>% 
