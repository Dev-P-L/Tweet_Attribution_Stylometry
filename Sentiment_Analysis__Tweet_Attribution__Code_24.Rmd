...
tab <- tweets_without_urls_and_apostrophes[index, ] %>%
  ...
  `colnames<-`(c("Identifier",
                 "Tweet with the Punctuation Mark \" ' \" after Text Mining",
...
```{r Frequency of enclosed punctuation marks outside of urls}
...
Five possibly interesting sequences 
